...
class SimpleModeSettingsManager(QObject):
    ...
    __ignored_custom_setting_keys = ["support_enable",
                                     ...
                                     "support_extruder_nr",
                                     "layer_height",
                                     "infill_pattern","speed_support","support_type","support_pattern","support_type","support_infill_rate",
                                     "support_angle","adhesion_type","speed_print","skirt_line_count","skirt_gap","adhesion_extruder_nr","brim_width",
                                     "raft_surface_layers","raft_margin","raft_surface_thickness","raft_surface_line_spacing","raft_base_line_spacing",
                                     "raft_base_thickness","raft_interface_thickness","raft_interface_line_spacing"]