...
Item
{
    ...
    property color headerBackgroundColor: UM.Theme.getColor("mat_show_background_color")
    property color headerActiveColor: UM.Theme.getColor("mat_show_active_color")
    property color headerHoverColor: UM.Theme.getColor("mat_show_hover_color")
