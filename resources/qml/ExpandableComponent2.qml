...
Item
{
    ...
    property color contentBackgroundColor: UM.Theme.getColor("bkColorScheme")

    property color headerBackgroundColor: UM.Theme.getColor("bkColorSchemeHeader")
    property color headerActiveColor: UM.Theme.getColor("bkColorSchemeHeaderActive")
    property color headerHoverColor: UM.Theme.getColor("bkColorSchemeHeaderHover")
    ...
    {
        contentContainer.visible = true//!expanded
    }
    ...
    Cura.RoundedRectangle
    {
        ...
        y:0// background.height + base.shadowOffset + base.contentSpacingY
        // Make the content aligned with the rest, using the property contentAlignment to decide whether is right or left.
        // In case of right alignment, the 3x padding is due to left, right and padding between the button & text.
        x: 0//contentAlignment == ExpandableComponent.ContentAlignment.AlignRight ? -width + collapseButton.width + headerItemLoader.width + 3 * background.padding : 0
        cornerSide: Cura.RoundedRectangle.Direction.All
        color: contentBackgroundColor
        //border.width: UM.Theme.getSize("default_lining").width
        //border.color: UM.Theme.getColor("lining")
        radius: UM.Theme.getSize("default_radius").width
        ExpandableComponentHeader2
        {
            id: contentHeader
            headerTitle: ""
