...
Button
{
    ...
    background: Rectangle
    {
        ...
        color:
        {
            ...
            {
                return UM.Theme.getColor("toolbar_button_active_hoverEXT")
            }
            else if (base.checked)
            {
                return UM.Theme.getColor("toolbar_button_activeEXT")
            }
            else if(base.hovered)
            {
                return UM.Theme.getColor("toolbar_button_hoverEXT")
            }
