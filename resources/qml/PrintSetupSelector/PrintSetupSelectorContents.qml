...
Item
{
    ...
    onCurrentModeIndexChanged: UM.Preferences.setValue("cura/active_mode", PrintSetupSelectorContents.Mode.Custom)//currentModeIndex)
    Item
    {
        id: contents
        ...
        RecommendedPrintSetup
        {
            ...
            visible: false//currentModeIndex == PrintSetupSelectorContents.Mode.Recommended
        }
       CustomPrintSetup
        {
            id: customPrintSetup
    ...
    Item
    {
        ...
        Cura.SecondaryButton
        {
            ...
            visible: false//currentModeIndex == PrintSetupSelectorContents.Mode.Custom
