...
SettingItem
{
    ...
    property int sliderValue:slider1.value
    property int minSliderValue:minValue
    property int maxSliderValue:maxValue
    onFocusReceived:
    {
...
/*
        ...
        {
            id:lbl1
            text:sliderValue.toFixed(precision)+(definition.unit)
            width:20
            anchors
            {
                left:slider1.right
