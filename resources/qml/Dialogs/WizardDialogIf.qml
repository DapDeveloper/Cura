...
UM.Dialog
{
    ...
    visible:true
    //: About dialog title
    title: catalog.i18nc("@title:window","About MTCSlicer2")
    ...
    Label
    {
        ...
        text: catalog.i18nc("@info:credit","MTCSlicer is developed by Meccatronicore.\nMTCSlicer proudly uses the following open source projects:")
        font: UM.Theme.getFont("system")
        wrapMode: Text.WordWrap
