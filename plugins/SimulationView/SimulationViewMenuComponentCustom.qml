...
Cura.ExpandableComponent2
{
    ...
    headerItem: Item
    {
        ...
        {
            id: colorSchemeLabel
            text: catalog.i18nc("@label", "Color scheme3")
    ...
    contentItem: Column
    {
        ...
        property bool show_legend: UM.SimulationView.compatibilityMode ? true : UM.Preferences.getValue("layerview/layer_view_type") == 0
        property bool show_gradient: UM.SimulationView.compatibilityMode ? false : UM.Preferences.getValue("layerview/layer_view_type") == 1 || UM.Preferences.getValue("layerview/layer_view_type") == 2
        property bool show_feedrate_gradient: show_gradient && UM.Preferences.getValue("layerview/layer_view_type") == 1
        property bool show_thickness_gradient: show_gradient && UM.Preferences.getValue("layerview/layer_view_type") == 2
        property bool show_extruders_gradient: show_gradient && UM.Preferences.getValue("layerview/layer_view_type") == 3
        ...
        ComboBox
        {
            ...
            function updateLegends(type_id)
            {
                ...
                viewSettings.show_legend = UM.SimulationView.compatibilityMode || (type_id == 0);
                viewSettings.show_gradient = !UM.SimulationView.compatibilityMode && (type_id == 1 || type_id == 2);
                viewSettings.show_feedrate_gradient = viewSettings.show_gradient && (type_id == 1);
                viewSettings.show_thickness_gradient = viewSettings.show_gradient && (type_id == 2);
                viewSettings.show_extruders_gradient = type_id == 3;
            }
        }
        Label
        {
        ...
        Repeater
        {
            ...
            CheckBox
            {
                ...
                UM.RecolorImage
                {
                    ...
                    color:index==0?UM.Theme.getColor("red_extruder"):UM.Theme.getColor("blue_extruder")//model.color//model.color
        ...
        Item
        {
            ...
            Label //Minimum value.
            {
                text:
                {
                    ...
                    {
                        // Feedrate selected
                        if (UM.Preferences.getValue("layerview/layer_view_type") == 1)
                        {
        ...
        Rectangle
        {
            ...
            visible: false//viewSettings.show_extruders_gradient
            anchors.left: parent.left
            anchors.right: parent.right
            height: Math.round(UM.Theme.getSize("layerview_row").height * 1.5)
            border.width: UM.Theme.getSize("default_lining").width
